<template>
  <div class="setting-panel" :style="{ height: `${height}px` }">
    ...
    <section class="st-cont">
      ...
      <free-practice v-if="select === 3" />
      <rhythm-game v-if="select === 4" />
      <!-- <record
                v-if="select===4"
            /> -->
    </section>
...
export default {
  components: {
    ...
    pcKeyboard,
    freePractice: () => import(/* webpackChunkName: "piano/free-practice" */ './panels/free-practice.vue'),
    // record: () => import(/* webpackChunkName: "piano/record" */'./panels/record/index.vue'),
    rhythmGame: () => import(/* webpackChunkName: "piano/free-practice" */ './panels/rhythm-game.vue'),
  },
  data() {
    return {
      height: 1000,
      ...
      manus: [
        ...
        ['电脑键盘映射', 'icon-jianpan'],
        ['初学练习', 'icon-music'], // 新增自由练习选项
        ['节奏游戏','icon-music'],// 新增['节奏游戏', 'icon-music'],
        // ['音轨录制', 'icon-luyin'],
        // '多人联机模式',
      ],
    };
